...
export const HeroSection = () => {
  return <section className="relative min-h-screen bg-background flex items-center justify-center text-center px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-foreground mb-8 tracking-[0.3em] uppercase hover:scale-105 transition-all duration-700 ease-out">
          BLUECHEF
        </h2>
